...
int main()
{
	...
	if(OBP>500)maxDepth=6;
	if(OBP>400)maxDepth=5;
	else if(OBP>300)maxDepth=4;
	else if(OBP>200)maxDepth=4;
	else if(OBP>100)maxDepth=5;
	else if(OBP>80)maxDepth=5;
	else if(OBP>60)maxDepth=5;
	else if(OBP>40)maxDepth=5;
	else if(OBP>20)maxDepth=5;
	else if(OBP>10)maxDepth=6;
	cout<<" game tree複雜度為 : "<<OBP<<" "<<onboardi<<" "<<onboardi2<<endl;
	int end=1;//結束則=0
	while(end)
	{
		dst="0";
