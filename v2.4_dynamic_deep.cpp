...
//更新:同分步時隨機選擇(阻止平手) 有計算movepoint(可吃或被吃加減分) 往中間13 14 17 18時分數+1 
...
int main()
{
	...
	if(onboardi<2)maxDepth=12;
	else if(onboardi<6)maxDepth=10;
	else if(onboardi<8)maxDepth=8;
	else if(onboardi<12)maxDepth=6;
	else if(onboardi<16)maxDepth=5;
