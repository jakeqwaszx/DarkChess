...
#include <string.h>
#include <sstream>
//目前版本2.4 使用pmove2遮罩減少搜尋時間 先使用移動搜尋8層有棋未翻可空過 結果更糟或相同則翻 
//翻子搜尋只到depth=2 depth3以上只搜移動或吃子 算分 棋力 - depth
//同分步時隨機選擇(阻止平手) 有計算movepoint(可吃或被吃加減分) 往中間13 14 17 18時分數+1 
//更新:試圖處理平局部分 
...
string current_position[32];//盤面狀況總覽 未實現 
string history; 
int timeCount;//剩餘時間 
...
int countAva(int pie[14],int deep)//將士相車馬炮兵
{
	...
	int movePoint=0;
	if(deep%2==0)
		movePoint=AEMindex*10+AOMindex-EAEMindex*100-EAOMindex;
	else
		movePoint=EAEMindex*10+EAOMindex-AEMindex*100-AOMindex;
...
int search(int depth,U32 curPiece[16],U32 curRed,U32 curBlack,U32 curOccupied,int curPie[14],int alpha,int beta)
{
	...
	U32 taEM[100][2];//存可吃子的方法 0 src 1 dst 避免被往下搜尋時刷掉 
...
int searchMove(int depth,U32 curPiece[16],U32 curRed,U32 curBlack,U32 curOccupied,int curPie[14],int alpha,int beta)
{
	...
	if(curPiece[15]!=0&&depth!=0)//可以走空步
	{
	...
	if(wp==1&&depth!=0) best=countAva(curPie,depth);
...
void dynamicPower()
{
	piPw[0]=6000+piece_count[7]*6000+piece_count[8]*2700+piece_count[9]*900+piece_count[10]*400+piece_count[11]*150+piece_count[12]*2000;
	piPw[1]=2700+piece_count[8]*2700+piece_count[9]*900+piece_count[10]*400+piece_count[11]*150+piece_count[12]*2000+piece_count[13]*100;
	piPw[2]=900+piece_count[9]*900+piece_count[10]*400+piece_count[11]*150+piece_count[12]*2000+piece_count[13]*100;
	piPw[3]=400+piece_count[10]*400+piece_count[11]*150+piece_count[12]*2000+piece_count[13]*100;
	piPw[4]=150+piece_count[11]*150+piece_count[12]*2000+piece_count[13]*100;
	piPw[5]=(2000+piece_count[7]*6000+piece_count[8]*2700+piece_count[9]*900+piece_count[10]*400+piece_count[11]*150+piece_count[12]*2000+piece_count[13]*100)/2;
	piPw[6]=(100+piece_count[7]*6000+piece_count[13]*100)/2;
	
	piPw[7]=6000+piece_count[0]*6000+piece_count[1]*2700+piece_count[2]*900+piece_count[3]*400+piece_count[4]*150+piece_count[5]*2000;
	piPw[8]=2700+piece_count[1]*2700+piece_count[2]*900+piece_count[3]*400+piece_count[4]*150+piece_count[5]*2000+piece_count[6]*100;
	piPw[9]=900+piece_count[2]*900+piece_count[3]*400+piece_count[4]*150+piece_count[5]*2000+piece_count[6]*100;
	piPw[10]=400+piece_count[3]*400+piece_count[4]*150+piece_count[5]*2000+piece_count[6]*100;
	piPw[11]=150+piece_count[4]*150+piece_count[5]*2000+piece_count[6]*100;
	piPw[12]=(2000+piece_count[0]*6000+piece_count[1]*2700+piece_count[2]*900+piece_count[3]*400+piece_count[4]*150+piece_count[5]*2000+piece_count[6]*100)/2;
	piPw[13]=(100+piece_count[0]*6000+piece_count[6]*100)/2;
}
