...
void dynamicPower()
{
	piPw[0]=100+100*(piece_count[7]+piece_count[8]+piece_count[9]+piece_count[10]+piece_count[11]+piece_count[12]);
	piPw[1]=100+100*(piece_count[8]+piece_count[9]+piece_count[10]+piece_count[11]+piece_count[12]+piece_count[13]);
	piPw[2]=100+100*(piece_count[9]+piece_count[10]+piece_count[11]+piece_count[12]+piece_count[13]);
	piPw[3]=100+100*(piece_count[10]+piece_count[11]+piece_count[12]+piece_count[13]);
	piPw[4]=100+100*(piece_count[11]+piece_count[12]+piece_count[13]);
	piPw[5]=1700;
	piPw[6]=100+100*(piece_count[13]+piece_count[7]);
	
	piPw[7]=100+100*(piece_count[0]+piece_count[1]+piece_count[2]+piece_count[3]+piece_count[4]+piece_count[5]);
	piPw[8]=100+100*(piece_count[1]+piece_count[2]+piece_count[3]+piece_count[4]+piece_count[5]+piece_count[6]);
	piPw[9]=100+100*(piece_count[2]+piece_count[3]+piece_count[4]+piece_count[5]+piece_count[6]);
	piPw[10]=100+100*(piece_count[3]+piece_count[4]+piece_count[5]+piece_count[6]);
	piPw[11]=100+100*(piece_count[4]+piece_count[5]+piece_count[6]);
	piPw[12]=1700;
	piPw[13]=100+100*(piece_count[6]+piece_count[0]);
}
