...
int countAva(int pie[14],int deep)//將士相車馬炮兵
{
	...
	int movePoint=0;
	if(deep%2==0)
		movePoint=AEMindex*10+AOMindex-EAEMindex*10-EAOMindex;
	else
		movePoint=EAEMindex*10+EAOMindex-AEMindex*10-AOMindex;
...
void dynamicPower()
{
	...
	piPw[5]=2000+piece_count[7]*6000+piece_count[8]*2700+piece_count[9]*900+piece_count[10]*400+piece_count[11]*150+piece_count[12]*2000+piece_count[13]*100;
	piPw[6]=100+piece_count[7]*6000+piece_count[13]*100;
	...
	piPw[12]=2000+piece_count[0]*6000+piece_count[1]*2700+piece_count[2]*900+piece_count[3]*400+piece_count[4]*150+piece_count[5]*2000+piece_count[6]*100;
	piPw[13]=100+piece_count[0]*6000+piece_count[6]*100;
}
