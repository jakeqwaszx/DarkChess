...
void dynamicPower()
{
	...
	//piPw[1]=2700;
	//piPw[2]=900;
	if(piece_count[9]==0&&piece_count[10]==0&&piece_count[11]==0&&piece_count[12]==0&&piece_count[13]==0)piPw[2]=0;
	//piPw[3]=400;
	if(piece_count[10]==0&&piece_count[11]==0&&piece_count[12]==0&&piece_count[13]==0)piPw[3]=0;
	//piPw[4]=150;
	if(piece_count[11]==0&&piece_count[12]==0&&piece_count[13]==0)piPw[4]=0;
	//piPw[5]=2000;
	if(piece_count[13]==0&&piece_count[7]==0)piPw[6]=0;
	//piPw[6]=100;
	
	//piPw[7]=6000;
	//piPw[8]=2700;
	//piPw[9]=900;
	if(piece_count[2]==0&&piece_count[3]==0&&piece_count[4]==0&&piece_count[5]==0&&piece_count[6]==0)piPw[9]=0;
	//piPw[10]=400;
	if(piece_count[3]==0&&piece_count[4]==0&&piece_count[5]==0&&piece_count[6]==0)piPw[10]=0;
	//piPw[11]=150;
	if(piece_count[4]==0&&piece_count[5]==0&&piece_count[6]==0)piPw[11]=0;
	//piPw[12]=2000;
	if(piece_count[0]==0&&piece_count[6]==0)piPw[13]=0;
	//piPw[13]=100;
}
