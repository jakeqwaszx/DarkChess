...
void initial();//初始化 
void chess(const vector<unsigned int> &tpiece, int deep, int& AEMindex, int& AOMindex, int& EAEMindex, int& EAOMindex, int allEatMove[50][2], int allOnlyMove[50][2]);//尋找可用移動
