...
double timec = 0;
double timee = 0;
int piPw[7] = { 6000,2700,900,400,150,2000,100};
//*******************************//
...
string winrecordverp = formattime + " verp.txt";
string winrecordverpw = formattime + " verpw.txt";
string winrecordvertime = formattime + " vertime.txt";
...
void printwinrecord(int state) {
	...
	ofstream foutrcp(winrecordverp, ios::app);
	ofstream foutrcpw(winrecordverpw, ios::app);
	ofstream foutrct(winrecordvertime, ios::app);
	if (state == 0) {
		...
		if (pwin != win) {
			winp += 16;
			winpw += 32910;
			foutrcp << totalturn << " ply cycle \n" << " ## createroom : " << winp << " ,   enterroom : " << losep << " ,  PlayTime : " << totalturn - turn + 1 << "  ##\n";
			foutrcpw << totalturn << " ply cycle \n" << " ## createroom : " << winpw << " ,   enterroom : " << losepw << " ,  PlayTime : " << totalturn - turn + 1 << "  ##\n";
		}
		else if (plose!=lose) {
			losep += 16;
			losepw += 32910;
		...
		foutrct << totalturn << " ply cycle \n" << "createroom total time use: " << timec << " ,   enterroom total time use: " << timee << " ,  PlayTime : " << totalturn - turn + 1 << endl;
		pwin = win;
		plose = lose;
		pdraw = draw;
	}
